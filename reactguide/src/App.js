...
const dummyExpenses = [
  {id :'i1', date: new Date(2020, 4, 12), title: "car", price: 2700 },
  { id :'i2',date: new Date(2020, 4, 29), title: "bus", price: 2800 },
  { id :'i3',date: new Date(2020, 4, 13), title: "phone", price: 28900 },
  { id :'i4',date: new Date(2020, 6, 23), title: "shoes", price: 2400 },
];
function App() {
